...
const CACHE = 'project-spotlight-v5';
const SHELL = [
  './', './index.html', './css/app.css', './manifest.webmanifest',
  './js/app.js', './js/ui.js', './js/pwa.js', './js/db.js', './js/store.js', './js/images.js', './js/migrate.js',
  './js/render.js', './js/presets.js', './js/icons.js', './js/icons-data.js', './js/caption.js',
  './js/views/home.js', './js/views/editor.js', './js/views/client.js', './js/views/settings.js',
  './vendor/qrcode.mjs',
